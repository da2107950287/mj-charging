    ...
    <div class="login">
      ...
      <div class="center">
        <van-form @submit="onSubmit">
          ...
          <van-field class="my-input mt20" v-model="passWord" type="password" mixlength="1"  maxlength="16" placeholder="请输入密码" :rules="rulesPassword">
            <template #left-icon>
              <span class="iconfont  icon-mima1"></span>
            </template>
          </van-field>
          <div class="picture-code-box">
            <van-field  class="my-input picture-code  mt20" v-model="imgCode" mixlength="1"  maxlength="8" placeholder="验证码"
              :rules="[{ required: true, message: '图片验证码' }]">
              <template #left-icon>
          ...
          <van-field v-if="showSmsCode" class="my-input mt20" mixlength="1"  maxlength="8" type="tel"  v-model="smsCode" placeholder="请输入手机验证码"
            :rules="rulesSmsCode">
            <template #left-icon>
              <span class="iconfont  icon-yanzhengma"></span>
            </template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        rulesPassword: [{ required: true, message: '密码不能为空' }],
      }
    },
    watch:{
      imgCode(){
